...
class InputSkills extends Component {
  ...
  addSkill = (e) => {
    ...
    if (e.key === "Enter" && value) {
      ...
      if (
        skills.find((skill) => skill.name.toLowerCase() === value.toLowerCase())
      ) {
              ...
              {skills.map((skill, i) => {
                return (
                  <li key={i}>
                    ...
                    {skill.name}
                    <select
                      class="form-select bg-warning urvinegi"
                      aria-label="Default select example"
                      name={i}
                      value={skill.rating}
                      onChange={this.setRating}
                    >
                      <option class="bg-warning" selected>
                        Rate your skill
                      </option>
                      <option class="bg-light" value="1">
                        ⭐
                      </option>
                      <option class="bg-light" value="2">
                        ⭐⭐
                      </option>
                      <option class="bg-light" value="3">
                        ⭐⭐⭐
                      </option>
                      <option class="bg-light" value="4">
                        ⭐⭐⭐⭐
                      </option>
                      <option class="bg-light" value="5">
                        ⭐⭐⭐⭐⭐
                      </option>
                    </select>
